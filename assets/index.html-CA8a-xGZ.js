import{_ as o,r as c,o as i,c as l,d as a,w as t,e as n,a as e,b as p}from"./app-KIhmIzTq.js";const u="/assets/string-6ebnTi6j.svg",r={},d=e(`<h2 id="类型说明" tabindex="-1"><a class="header-anchor" href="#类型说明" aria-hidden="true">#</a> 类型说明</h2><p>在 Go 语言中所提供的字符串（string）是一种基础的数据类型，在编程开发中几乎随时都会使用，本篇文章将会介绍字符串（string）的知识，帮助你更好的理解它。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// src/builtin/builtin.go</span>
